...
def handle_help(message):
    ...
    url_button = types.InlineKeyboardButton(text="Написать в техподдержку", url="https://telegram.me/siasplushelp")
...
def handle_text(message):
    ...
    user_markup.row('☎ Контакты ☎', '💎ЗАРАБОТАТЬ')
        ...
        keyboard = types.InlineKeyboardMarkup()
        url_button = types.InlineKeyboardButton(text="Канал SIAS Plus in Telegram", url="https://t.me/siasplus")
